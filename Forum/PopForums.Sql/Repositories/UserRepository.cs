...
namespace PopForums.Sql.Repositories
{
    ...
    public virtual User CreateUserByID(int UserID, string name, string email, DateTime creationDate, bool isApproved, string hashedPassword, Guid authorizationKey, Guid salt)
    {
      ...
      DbCommand command;
      command = connection.Command(_sqlObjectFactory, "SET IDENTITY_INSERT pf_PopForumsUser ON");
      command.Transaction = trans;
      command.ExecuteNonQuery();

      command = connection.Command(_sqlObjectFactory, "INSERT INTO pf_PopForumsUser (UserID, Name, Email, CreationDate, IsApproved, LastActivityDate, LastLoginDate, AuthorizationKey, Password, Salt) VALUES (@UserID, @Name, @Email, @CreationDate, @IsApproved, @LastActivityDate, @LastLoginDate, @AuthorizationKey, @Password, @Salt)")
      ...
      command = connection.Command(_sqlObjectFactory, "SET IDENTITY_INSERT pf_PopForumsUser OFF");
      command.Transaction = trans;
      command.ExecuteNonQuery();
      ...
      return new User(UserID, creationDate) { Name = name, Email = email, IsApproved = isApproved, LastActivityDate = creationDate, LastLoginDate = creationDate, AuthorizationKey = authorizationKey };
    }
