...
namespace Models.Context
{
    public class MainContext : DbContext
    {
        ...
        public virtual DbSet<ConsultationDocumentType> ConsultationDocumentTypes { get; set; }
        public virtual DbSet<vSourceItems> vSourceItems { get; set; }
        public virtual DbSet<MSProgram> MSPrograms { get; set; }
        public virtual DbSet<MSProgramProject> MSProgramProjects { get; set; }
