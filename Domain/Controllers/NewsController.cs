...
namespace Domain.Controllers
{
    public class NewsController : BasePortalController
    {
        ...
        public IActionResult Index(int category = -1)
        {
            ...
            ViewBag.categories = service.NewsCategories_SelectCombo(this.Lang).ToSelectList(category).AddAllItem().DecodeIfNeeded();
        ...
        public IActionResult LoadData(IDataTablesRequest request, int? categoryId, string searchTerm)
        {
            ...
            var data = service.News_Select(categoryId.EmptyToNull(), searchTerm.EmptyToNull(), this.Lang);
        ...
        public IActionResult View(int id)
        {
            ...
            ViewBag.categories = service.NewsCategories_SelectCombo(this.Lang).ToSelectList(model.CategoryId).AddAllItem();
            return View(model);
        }
